...
class DDPG_HER:
    def __init__(self, args, env, env_params):
        ...
        if os.path.isfile(os.path.join(self.args.model_dir, os.path.join(self.args.env_name,"actor_her.pth"))):
            self.actor.load_state_dict(torch.load(os.path.join(self.args.model_dir, os.path.join(self.args.env_name,"actor_her.pth"))))
    ...
    def train(self):
        ...
        for epoch in range(self.args.epochs):
            ...
            while not done and (episode < self.args.timesteps):
                #self.env.render()
            ...
            sys.stdout = original
            # # Save model
            torch.save(self.actor.state_dict(), os.path.join(self.args.model_dir, os.path.join(self.args.env_name,"actor_her.pth")))
